// 04 - Crie uma função chamada verificarNumero que receba um número como parâmetro e retorne uma Promise. 
// A Promise deverá:
...
// Utilize os elementos .then() e .catch() para exibir o resultado da Promise no console.
